...
class Road:
    ...
    def calculate(self, mass, thick):
        print(f'вам птребуется {round(self._width * self._length * mass * thick / 1000)} тонн асфальта')


road_work = Road(5000, 20)
road_work.calculate(25, 5)
