def check_input(input_list):
    """
    Проверка ввода пользователя, на вход получаем список элементов, проверяем что бы там были только цифры и $ в конце
    или просто $. True если ввод корректен и False если не корректен
...
while is_stop:
    ...
    if check_input(list_of_elements):
        ...
        print('вы ввели не привильную строку. необходимо ввести числа через пробел и $ в конце строки или просто $')
